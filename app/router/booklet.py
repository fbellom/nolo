...
async def update_one_booklet(
    ...
    try:
        ...
        udpd_expr = update_item_and_counter(table=table, item_key=item_key,attributes=item)
...
async def toogle_visibility_booklet(
    ...
    try:
        ...
        return {"booklet_id": doc_id, "username": user.username, "is_published" : item['is_published'], "modify_at" : item['modify_at'] } 
